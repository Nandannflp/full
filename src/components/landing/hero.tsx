...
function DashboardMockup() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-3xl bg-[#111B27] border border-white/10 shadow-2xl shadow-black/40"
    >
      {/* ── Title bar ── */}
      ...
      <div className="p-3">
        ...
        <div className="grid grid-cols-3 gap-2 mb-2">
          <div className="col-span-2 rounded-2xl bg-[#1E2B3C] border-white/10 p-3">
          ...
          <div className="col-span-1 rounded-2xl bg-[#1E2B3C] border-white/10 p-3 flex flex-col justify-between">
        ...
        <div className="grid grid-cols-3 gap-2 mb-2">
          {PERF.map((c, i) => (
            <motion.div key={c.label}
              ...
              className="rounded-2xl bg-[#1E2B3C] border-white/10 p-3 cursor-pointer"
            >
        ...
        {/* ── Full-width chart ── */}
        <div className="rounded-2xl bg-[#1E2B3C] border-white/10 p-3 mb-2">
        ...
        {/* ── AI assistant bar ── */}
        <div className="flex items-center gap-2 rounded-2xl bg-[#1E2B3C] border-white/10 p-3">
