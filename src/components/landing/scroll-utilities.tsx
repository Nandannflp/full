      ...
      <AnimatePresence>
        {showTop && (
          ...
          >
            ...
            <span className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-gradient-to-br from-primary/0 to-accent/0 opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-hover:from-primary/20 group-hover:to-accent/20" />
          </motion.button>
        )}
      </AnimatePresence>
    </>
