      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="group fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full glass-strong text-slate-900 shadow-[0_8px_30px_-6px_rgba(2,6,23,0.8)] transition-all duration-300 hover:border-[#3b82f6]/60 hover:text-[#38bdf8] hover:shadow-[0_0_28px_-4px_rgba(59,130,246,0.7)]"
          >
