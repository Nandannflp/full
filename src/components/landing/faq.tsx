        ...
        >
          {FAQS.map((f, i) => (
            <AccordionItem
              key={f.q}
              value={`faq-${i}`}
              className="group overflow-hidden rounded-2xl border border-slate-900/10 bg-[#0A0A0A]/[0.03] px-5 backdrop-blur-sm transition-all duration-300 data-[state=open]:border-[#3b82f6]/40 data-[state=open]:bg-[#3b82f6]/[0.06] data-[state=open]:shadow-[0_8px_40px_-12px_rgba(37,99,235,0.4)]"
            >
