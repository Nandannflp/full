...
const PROJECTS = [
  ...
  },
  {
    ...
    metric: "+340% AOV",
    gradient: "from-[#3b82f6] via-[#2563eb] to-[#38bdf8]",
  },
  {
    name: "Orbit Studio",
  ...
  },
  {
    ...
    gradient: "from-[#2563eb] via-[#06b6d4] to-[#3b82f6]",
  },
];
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white transition-all hover:border-[#3b82f6]/50 hover:bg-[#3b82f6]/10 hover:text-[#38bdf8]"
          >
...
function MacBook({ gradient, name }: { gradient: string; name: string }) {
  return (
    <div className="relative">
      {/* Screen */}
      <div className="relative rounded-[14px] border border-white/10 bg-[#0a1428] p-1.5 shadow-[0_30px_60px_-20px_rgba(2,6,23,0.9)] transition-all duration-500 group-hover:shadow-[0_30px_70px_-15px_rgba(37,99,235,0.5)]">
        <div className="overflow-hidden rounded-[10px]">
          <div className="relative aspect-[16/10]">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-500 group-hover:opacity-100">
              <span className="flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-xs font-semibold text-white backdrop-blur-md">
      ...
      <div className="relative mx-auto h-3 w-[112%] -translate-x-[5.3%] rounded-b-[10px] rounded-t-[3px] bg-gradient-to-b from-[#1e293b] to-[#0f172a]">
        <div className="absolute left-1/2 top-0 h-1 w-20 -translate-x-1/2 rounded-b-lg bg-[#020617]" />
      </div>
    </div>
  );
}
